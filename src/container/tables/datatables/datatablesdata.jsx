  ...
  export const BasicTable = () => {
    ...
    return (
      <>
        ...
        <div className="table-hover table-bordered table-responsive" id="bascitable">
        <table {...getTableProps()} className="table table-hover mb-0 w-full ">
          <thead>
            {headerGroups.map((headerGroup) => (
              <tr className="border-b" {...headerGroup.getHeaderGroupProps()} key={Math.random()}>
            ...
            {page.map((row) => {
              ...
              return (
                <tr {...row.getRowProps()} key={Math.random()}>
                  {row.cells.map((cell) => {
                    return (
                      <td className="border-e border-b dark:border-defaultborder/10" {...cell.getCellProps()} key={Math.random()}>
                        {cell.render("Cell")}
                      </td>
                    );
                  })}
