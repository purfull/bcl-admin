...
export const ResponsiveAdminUserDataTable = ({ data = [], onEdit, onDelete, active }) => {
    ...
    <>
      <div className="e-table pb-5">
        ...
        <div className="flex">
          ...
          <div className="">
            <button className='px-[1vw] py-[1.5vh] bg-violet-700 text-white ml-[1vw] rounded-md ' onClick={() => {onEdit({ newAdminUser: true }) }} >+ NEW USER</button>
          </div>
        </div>
