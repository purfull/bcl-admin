...
// import '../org/org.css';
import { ResponsiveUserMasterDataTable } from './UserMasterData';
...
const UserMaster = () => {
  ...
  return (
    <Fragment>
      <Pageheader currentpage="User Master" activepage="Security" mainpage="User Master" />
