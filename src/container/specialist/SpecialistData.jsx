...
export const ResponsiveSpecialistDataTable = ({ data = [], onEdit, onDelete, active }) => {
    ...
    <>
      <div className="e-table pb-5">
        ...
        <div className="flex">
          ...
          <div className="">
            <button className='px-[1vw] py-[1.5vh] bg-violet-700 text-white ml-[1vw] rounded-md ' onClick={() => {onEdit({ newBusiness: true }) }} >+ NEW SPECIALIST</button>
          </div>
        </div>
