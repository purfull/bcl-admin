...
import EditBranch from "./EditCountry";
import '../org/org.css';
import { ResponsiveBranchDataTable } from "./CountryData";
  ...
  useEffect(() => {
    if (data.length > 0) {
      setListData(data.map(el => ({
        ...
        CountryCurrencyCode: el.CountryCurrencyCode,
        CountryCurrencySymbol: el.CountryCurrencySymbol
      })));
    }
  }, [data]);
  return (
    <Fragment>
      <Pageheader currentpage="Country" activepage="Master" mainpage="Country" />
