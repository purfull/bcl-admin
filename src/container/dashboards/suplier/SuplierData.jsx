...
const ResponsiveBranchDataTable = ({ data, onEdit }) => {
    ...
    <>
      <div className="e-table pb-5">
        ...
        <div className="flex">
          ...
          <div className="">
            <button className='px-[1vw] py-[1.5vh] bg-violet-700 text-white ml-[1vw] rounded-md '>+ NEW BRANCH</button>
...
export default ResponsiveBranchDataTable;