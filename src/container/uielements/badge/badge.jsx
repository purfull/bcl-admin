  ...
  <Pageheader currentpage="Badge" activepage="Ui Elements" mainpage="Badge" />
            <div className="grid grid-cols-12 gap-x-6">
                <div className="xl:col-span-6 col-span-12">
                        <Showcode title="Badges" code={badges1} customCardBodyClass="flex flex-wrap gap-2">
                            {badges.map((idx) => (
                ...
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Pill Badges" code={badges2} customCardBodyClass="flex flex-wrap gap-2">
                            {badges.map((idx) => (
                            <span className={`badge !rounded-full bg-${idx.color}`} key={Math.random()}>{idx.class}</span>
                            ))}
                        </Showcode>
                    </div>
            </div>
            ...
            <div className="grid grid-cols-12 gap-x-6">
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Gradient Badges" code={badges5} customCardBodyClass="flex flex-wrap gap-2">
                            ...
                            <span className={`badge bg-${idx.color}-gradient`} key={Math.random()}>{idx.class}</span>
                            ))}
                        </Showcode>
                </div>
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Gradient Pill Badges" code={badges6} customCardBodyClass="flex flex-wrap gap-2">
                        {gradientbadge.map((idx)=>(
                            <span className={`badge rounded-full bg-${idx.color}-gradient`} key={Math.random()}>{idx.class}</span>
                            ))}
                        </Showcode>
                </div>
            </div>
            <div className="grid grid-cols-12 gap-x-6">
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Outline Badges" code={badges7} customCardBodyClass="flex flex-wrap gap-2">
                            ...
                            <span className={`badge bg-outline-${idx.color}`} key={Math.random()}>{idx.class}</span>
                            ))}
                        </Showcode>
                </div>
                <div className="xl:col-span-6 col-span-12">
                    <Showcode title="Outline Pill Badges" code={badges8} customCardBodyClass="flex flex-wrap gap-2">
                            {outlinebadges.map((idx) => (
                            <span className={`badge !rounded-full bg-outline-${idx.color}`} key={Math.random()}>{idx.class}</span>
                            ))}
                        </Showcode>
                </div>
            </div>
                ...
                <div className="xl:col-span-6 col-span-12">
                    <div className="grid grid-cols-12 gap-6">
                        <div className="xl:col-span-12 col-span-12">
                            ...
                            <Showcode title="Custom Badges" code={badges13}>
