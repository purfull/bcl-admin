...
import { defaultalerts, iconalerts, roundedalerts, shadows, solidalert, solidalert1 } from './alertsdata';
import { Alertimages, Customizedalerts, Defaultalerts, Differentalerts, Differentshadows, Iconalerts, Imagealerts, Linkalerts, Roundedalerts, Solidcoloralerts, additionaldata, alerts, alerts1, custombuttons, outlinealerts, outlinerounded, roundeddefault } from '../../../components/ui/data/uielementsdata';
...
const Alerts= () => {
  ...
  <Fragment>
            ...
            <div className="grid grid-cols-12 gap-x-6">
                ...
                <div className="xxl:col-span-6 col-span-12">
                    <Showcode title="Solid Alerts" code={Solidcoloralerts}>
                        {solidalert.map((idx) => (
                    ...
                    <Showcode title="Solid Alerts With Different Shadows" code={Differentshadows}>
                        {shadows.map((idx) => (
                            ...
                            <div className={`alert alert-solid-${idx.color} alert-dismissible fade show flex`} role="alert" key={Math.random()}
                                id="dismiss-alert18">
                                <div className="sm:flex-shrink-0">
                                    {`A simple solid ${idx.color} alert with small shadow—check it out!`}
                                </div>
                                <div className="ms-auto">
                                    <div className="mx-1 my-1">
                                        <button type="button"
